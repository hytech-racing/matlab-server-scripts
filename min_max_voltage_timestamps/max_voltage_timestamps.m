function result = max_voltage_timestamps(filePath)
    parsed = parse(filePath);
   
    ids = parsed.ACUAllData.max_cell_voltage_id.Data;
    times = parsed.ACUAllData.max_cell_voltage_id.Timestamp;
    ...
    % Define file name
    fileName = ['/data/mps_generated/' char(matlab.lang.internal.uuid()) '/max_voltage_timestamps.mat'];
